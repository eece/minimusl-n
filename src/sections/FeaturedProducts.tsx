...
export const FeaturedProducts: React.FC<FeaturedProductsProps> = ({
  ...
  subtitle = "En sevilen tasarımlarımızla tanışın.",
  products = [
    {
      id: 1,
      ...
      link: "https://www.trendyol.com/magaza/minimuslin-m-966952"
    },
    {
      id: 2,
    ...
    <section className="py-12">
      <div className="mx-auto max-w-[1200px] px-4 md:px-10">
        ...
        <Swiper
          ...
          className="pb-32"
          style={{ '--swiper-pagination-bottom': '-1px', 'paddingBottom':'32px', '--swiper-pagination-color': '#d2b38e' } as React.CSSProperties}
        >
            ...
            <SwiperSlide key={product.id}>
              ...
              >
                ...
                <div className="p-5 space-y-4">
                  ...
                  <a 
                    href={product.link || "https://www.trendyol.com/magaza/minimuslin-m-966952"} 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="block w-full bg-background-light border border-primary/30 hover:border-primary text-slate-900 font-bold py-3 rounded-lg transition-colors text-center"
                  >
                    Trendyol'da İncele
                  </a>
                </div>
